...
``````````
## OUTPUT:
<img width="1230" height="633" alt="image" src="https://github.com/user-attachments/assets/fe7a8f3a-1b94-434a-bc39-b4e4fc17127b" />


## RESULT:
Thus the program has been executed by using CUDA to mulptiply two matrices. It is observed that there are variations in host and device elapsed time. Device took ____________ 0.000163 __time and host took ____ 0.000203_______time.
